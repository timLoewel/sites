...
import {setCurrentLocation, setCurrentAddress, startGPS, updateLocation, stopGPS,} from './systemStateReducer';
...
export default combineEpics(onStoreInitializedEpic, startGPSEpic, printGeolocationErrorsEpic, addressEpic, updateLocationEpic, addressEpic);
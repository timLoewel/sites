...
export const submitProfileForm = createAction('submitProfileForm: Submit Profile Form');

export const submitProfileOk = createAction('submitProfileOk: Submit Profile OK');

export const submitProfileFailed = createAction('submitProfileFailed: Submit Profile FAILED');

export const showLoginScreen = createAction('showLoginScreen: show the login screen');
/**
 * the payload is the user profile, as returned from the server
 * @type {ActionCreator<P, M>}
 */
export const userLoginSuccess = createAction('userLoginSuccess: user logged in successfully');

export const userLoginFailed = createAction('userLoginFailed: user login failed');

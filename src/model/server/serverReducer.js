...
export const addObject = createAction('addObject: new or updated object from server');

export const removeObject = createAction('removeObject: object removed by server');

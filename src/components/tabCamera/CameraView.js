...
import { createNewSite, addNewLocalSite } from "../../model/site/siteReducer";
...
var a = 22; // expecting error in eslint
/**
...
class CameraView extends Component {
  ...
  _renderDescriptionInput() {
    const fontSize: number = this.state.descriptionFocused
      ? theme.inputFontSize
      : theme.fontSizeSmall;
    return (
      <View
      ...
      >
        ...
        >
          <Text style={{ fontSize: theme.fontSizeBase, fontWeight: "bold" }}>
            {I18n.t("camera.descriptionTitle")}
          </Text>
  ...
  _renderShutterButtonRow() {
    ...
    return (
      <View
        style={{
          // container of shutter button row
          flexDirection: "row",
          alignSelf: "stretch",

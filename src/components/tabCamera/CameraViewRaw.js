...
import type {IUserPointer, ISearchableLocation, IObjectId, ILocation} from '../../model/ModelTypes';
					...
					<View style={{ // first column, locations
						...
						>
							<View style={{// row with indoor location
								...
								>
									<Icon name="indoor-position"
												style={{width: theme.fontSizeH2, fontSize: theme.fontSizeH1, color: 'white'}}/>
								</TouchableHighlight>
								<TextInput
										ref="onSiteLocation"
										placeholderTextColor={theme.subtitleColor}

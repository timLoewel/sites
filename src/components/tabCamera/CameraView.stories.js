...
storiesOf("CameraView", module).add("long description", () =>
  <CameraView
    selectedLocation={{
      longitude: 22,
      latitude: 12,
      accuracy: 1,
      address: {
        formattedAddress: "somewhere selected Strasse 22, 123 Obersland"
      }
    }}
    ...
    systemLocation={{
      ...
      latitude: 11,
      accuracy: 1,
      address: { formattedAddress: "system location is here" }
    }}

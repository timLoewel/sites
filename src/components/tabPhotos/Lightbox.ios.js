...
class Lightbox extends React.Component{
	...
	render() {
		const listData = this.state.listViewDataSource.cloneWithRows(this.props.mediaList);

		return (
				<ListView
						ref={component => this._root = component}
						style={{position: 'absolute', top: 0, left: 0, width: windowWidth, height: windowHeight, backgroundColor: 'black'}}
						dataSource={listData}
